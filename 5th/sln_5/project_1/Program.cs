...
namespace project_1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            switch (input % 2)
            {
                case 0: Console.WriteLine("짝수");
                    break;
                case 1: Console.WriteLine("홀수");
                    break;
            }
            */
            ...
            if (DateTime.Now.Hour < 11) { Console.WriteLine("아침을 먹을 시간입니다."); } 
            else if(DateTime.Now.Minute < 15) { Console.WriteLine("점심을 먹을 시간입니다"); }
            else { Console.WriteLine("저녁을 먹을 시간입니다."); }
            */
