...
namespace project_3
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // foreach(var item in list) { Console.WriteLine(item.name + " : " + item.grade); }
            List<Student> a = new List<Student> { 
                ...
                new Student() { name="육제이", grade=3 }
            };
            foreach (var item in a) { Console.WriteLine(item.name + " : " + item.grade); }
        }
    }
}
